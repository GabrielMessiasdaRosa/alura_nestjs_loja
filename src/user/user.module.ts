...
@Module({
  // 👈 Module decorator is a class decorator that defines a module, a module encapsulates related functionality into a single unit.
  imports: [TypeOrmModule.forFeature([UserEntity])], // 👈 imports array is a list of modules that this module depends on.
